            ...
            <div class="row">
              <div class="col-md-4">
                <div class="card" style="background-color: #b4e9f9;">
                  ...
                  <div class="card-body">
                    <h5 class="card-title fw-bold" style="font-size: 50px">150</h5>
              ...
              <div class="col-md-4">
                <div class="card" style="background-color:#bdf8c3;">
                  ...
                  <div class="card-body">
                    <h5 class="card-title fw-bold" style="font-size: 50px">12,340</h5>
              ...
              <div class="col-md-4">
                <div class="card" style="background-color:#fbf2b7;">
                  ...
                  <div class="card-body">
                    <h5 class="card-title fw-bold" style="font-size: 50px">10</h5>
