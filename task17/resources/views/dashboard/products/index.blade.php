...
<x-app-layout>
  ...
  <div class="d-flex justify-content-between align-items-center mb-4">
    <a href="{{ 'add-new-product' }}" class="btn btn-success">+ Add New Product</a>
  </div>
    ...
    <table class="table table-bordered table-hover align-middle">
      ...
      <tbody>
        <tr>
          ...
          <td><img src="https://placehold.co/100" alt="Gambar Produk" class="thumbnail"></td>
          <td>15</td>
          <td>Rp 3.500.000</td>
          <td>
            <a href="{{ 'edit-product' }}" class="btn btn-sm btn-warning">Edit</a>
